...
GitHubService.check = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: fresheyes_pb.Empty,
  responseType: fresheyes_pb.Empty
};
...
GitHubServiceClient.prototype.check = function check(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(GitHubService.check, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,

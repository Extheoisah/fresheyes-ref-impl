...
type GitHubServicecheck = {
  readonly methodName: string;
  readonly service: typeof GitHubService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof fresheyes_pb.Empty;
  readonly responseType: typeof fresheyes_pb.Empty;
};
...
export class GitHubService {
  ...
  static readonly check: GitHubServicecheck;
}
...
export class GitHubServiceClient {
  ...
  check(
    requestMessage: fresheyes_pb.Empty,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: fresheyes_pb.Empty|null) => void
  ): UnaryResponse;
  check(
    requestMessage: fresheyes_pb.Empty,
    callback: (error: ServiceError|null, responseMessage: fresheyes_pb.Empty|null) => void
